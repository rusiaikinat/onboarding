...
@Table(name = "ABC_USER", indexes = {
        @Index(name = "IDX_ABC_USER_ON_USERNAME", columnList = "USERNAME", unique = true),
        @Index(name = "IDX_ABC_USER_DEPARTMENT", columnList = "DEPARTMENT_ID")
})
